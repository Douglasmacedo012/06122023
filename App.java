...
public class App {
    ...
    public static Connection conectar() {
        ...
        try {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver").newInstance(); conn = DriverManager.getConnection(mysqlUrl,mysqlUser,mysqlPass);
            status = "Connection opened";
            String strSqlTeste = "CREATE TABLE `teste`.`tbl_teste` (`id` INT NOT NULL AUTO_INCREMENT,`nome` VARCHAR(255) NULL, PRIMARY KEY (`id`))"; // texto corrido
